...
- `docs/en/AIOutputContract.md` and `docs/zh/AIOutputContract.md`: stable output engineering contract. Present the implemented envelope, output families, schemas, validation/normalization, provider mapping, correction, errors, observability, versioning, and user-confirmation boundary as a coherent protocol, not a completed todo list. Current release/activation status belongs in `docs/ROADMAP.md`; completed Phase 5 rollout evidence belongs in `docs/history/phase5/PHASE5_AI_RAG_FINAL_ENGINEERING_RECORD.md`.
