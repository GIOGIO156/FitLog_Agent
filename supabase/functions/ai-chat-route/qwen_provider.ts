...
function systemMessage(request: GatewayRequest): string {
  ...
  return [
    ...
    "For text, draft must be null. For a requested draft, return the exact draft type or one clarification with draft null. Never claim the result was saved.",
  ].join("\n");
}
...
function textUserPrompt(
  ...
  return [
    ...
    '{"schema_version":"provider_gateway_envelope.v1","message":{"text":"Friendly user-facing Markdown."},"needs_clarification":false,"clarification_questions":[],"draft":null}',
...
function multimodalUserPrompt(request: GatewayRequest): string {
  ...
  return [
    ...
    '{"schema_version":"provider_gateway_envelope.v1","message":{"text":"..."},"needs_clarification":false,"clarification_questions":[],"draft":null}',
