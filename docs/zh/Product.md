...
| --- | --- | --- | --- |
| Home | 选中日期仪表盘。 | 本地日汇总、饮食上下文、宏量/kcal 展示、紧凑饮食/训练卡。 | 通过 cloud-backed records repository 构建日汇总，把选中日期 confirmed summary 写入本地 cache，并用 stale-while-revalidate 刷新 Home；云端 daily summary upsert 仍属 Phase 3 hardening。 |
