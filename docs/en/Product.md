...
- Transient notices must be dismissible, expire automatically, and stay scoped to the originating surface; tab or route changes cannot carry an old error into an unrelated module.
