...
- Assistant messages render basic Markdown for paragraphs, headings, bold text, ordered/unordered lists, inline code, and code blocks. User messages remain plain text. The chat renderer does not load remote Markdown images or execute link actions.
